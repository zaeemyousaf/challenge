...
start:
	...
	;; mov ax,1		height
	;; push ax
	;; mov ax,0x40		red color, foreground has no color as it is just space
	;; push ax
	;; mov ax,1		on first column
	;; push ax
	;; mov ax,10		on first line
	;; push ax
	;; call draw_rectangle
	...
	;; mov ax,1		;on first column
	;; push ax
	;; mov ax,2		;on first line
	;; push ax
	;; call draw_rectangle
	
	;; push 2			;random number
	;; push 5			; min
	;; push 10			; max
	;; call random_in_range
	;; pop ax

	;; push 3			; on first line
	;; push 0x56
	;; call draw_bricks_layer
	;; push 2			;random number
	;; push 5			; min
	...
	;; stack[length,height,fill_col,pos_x,pos_y,call
	;; call clearScreen
	;; mov ax,bricks2
	;; push ax
	;; mov ax,0x47
